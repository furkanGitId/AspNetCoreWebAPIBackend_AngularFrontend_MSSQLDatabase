...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "AspNet Core Web API", Version = "v1" });
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "AspNet Core Web API v1");

        // Inject custom JavaScript for JWT token expiry timer
